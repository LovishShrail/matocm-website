...
import '../components/HackerText.js';
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      {activeItem && (
        <>
          ...
          <HackerText text={activeItem.title} />
          </h2>

          <p className={`face-description ${isMoving ? 'inactive' : 'active'}`}><HackerText text={activeItem.description} /></p>
